...
import com.example.springbootmongodb.entities.Person;
import com.example.springbootmongodb.repositories.PersonRepository;
...
public class PersonServiceImpl implements PersonService{
    ...
    @Override
    public List<Person> getByAge(Integer minAge, Integer maxAge) {
